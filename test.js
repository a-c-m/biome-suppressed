...
test("parseGitHubErrors: parses valid GitHub error format", () => {
	const input = `::error title=lint/style/useNamingConvention,file=src/test.js,line=42,endLine=42,col=10,endColumn=20::Variable name should be camelCase`;
...
test("parseGitHubErrors: normalizes file paths with forward slashes", () => {
	const input = `::error title=rule1,file=src\\test\\file.js,line=1,endLine=1,col=1,endColumn=1::message`;
	const result = parseGitHubErrors(input);
